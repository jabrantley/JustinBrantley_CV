...
\begin{adjustwidth}{0.5em}{0pt}
    \begin{itemize}
    % First project
    \item[\color{accent}\ding{224}] {\color{emphasis}\textbf{Bayesball: Bayesian Integration in Professional Baseball Batters (lead) \hfill \cvtag{\href{https://github.com/jabrantley/Bayesball}{\faGithub}~Project Repo,~~\href{https://youtu.be/i4jBHfjPDnI}{ \faYoutubePlay}~~NMC 4.0}}}\\
...
\begin{adjustwidth}{0.5em}{0pt}
    \begin{itemize}
    % First project
    \item[\color{accent}\ding{224}] {\color{emphasis}\textbf{Non-invasive BMIs for Control of Prosthetic Devices (lead) \hfill \cvtag{\href{https://github.com/jabrantley/NEUROLEG}{\faGithub}~Project Repo,~~\href{https://www.youtube.com/watch?v=gVW28Um2uKo}{\faYoutubePlay}~Featured here}}}\\
    \smallskip
        % Project highlights
        \begin{itemize}
